...
async def test_prospect_tables_are_rls_protected_and_privileges_are_narrow() -> None:
    ...
    assert policies == {
        ...
        "provenance_records_worker_connector_ingest",
        "prospects_worker_connector_ingest",
        "contacts_worker_connector_ingest",
        "contact_channels_worker_connector_ingest",
        "contact_permissions_worker_connector_ingest",
